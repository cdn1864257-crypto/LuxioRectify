...
export const emailTranslations: Record<EmailLanguage, EmailTranslations> = {
  fr: {
    ...
    proof_instruction: '⚡ ASTUCE : Pour un traitement prioritaire, envoyez-nous votre justificatif de virement à support@luxiomarket.shop. Cela nous permettra de traiter votre commande jusqu\'à 48h plus rapidement.',
  ...
  en: {
    ...
    proof_instruction: '⚡ TIP: For priority processing, send us your payment proof to support@luxiomarket.shop. This will allow us to process your order up to 48 hours faster.',
  ...
  es: {
    ...
    proof_instruction: '⚡ CONSEJO: Para un procesamiento prioritario, envíenos su comprobante de pago a support@luxiomarket.shop. Esto nos permitirá procesar su pedido hasta 48 horas más rápido.',
  ...
  pt: {
    ...
    proof_instruction: '⚡ DICA: Para processamento prioritário, envie-nos seu comprovante de pagamento para support@luxiomarket.shop. Isso nos permitirá processar seu pedido até 48 horas mais rápido.',
  ...
  pl: {
    ...
    proof_instruction: '⚡ WSKAZÓWKA: Dla priorytetowego przetwarzania, wyślij nam potwierdzenie płatności na support@luxiomarket.shop. Pozwoli nam to przetworzyć Twoje zamówienie nawet o 48 godzin szybciej.',
  ...
  hu: {
    ...
    proof_instruction: '⚡ TIPP: Prioritásos feldolgozáshoz küldje el fizetési igazolását a support@luxiomarket.shop címre. Ez lehetővé teszi számunkra, hogy akár 48 órával gyorsabban feldolgozzuk rendelését.',
